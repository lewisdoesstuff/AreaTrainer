...
Module Module1
    ...
    Sub names()
        ...
        If File.Exists("login\Users\" & name & ".csv") Then
        Else
            ...
            Main()
        End If
        Dim pass As String = My.Computer.FileSystem.ReadAllText("login\Users\" & name & ".csv")
    ...
    Sub Register()
        ...
        If File.Exists("login\Users\" & user & ".csv") Then
        ...
        My.Computer.FileSystem.WriteAllText("login\Users\" & user & ".csv", pass, False)
    ...
    Sub circle()
        ...
        Console.WriteLine("  *        *")
        Console.WriteLine("     *  *")
        Dim area = CInt(Math.Floor((10 - 1 + 1) * Rnd())) + 1
